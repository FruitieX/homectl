 ...
 */
path: string, node_id?: NodeId, truth: TruthValue, evaluated: boolean, error?: string, unknown_reason?: UnknownReason, 
/**
 * Full group evaluation for group condition nodes, so native results,
 * SDK helpers, and UI traces agree exactly (G07).
 */
group?: GroupEvaluation, children?: Array<ConditionTraceNode>, };
