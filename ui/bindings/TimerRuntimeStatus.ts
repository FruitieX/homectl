 ...
 */
export type TimerRuntimeStatus = { routine_id: RoutineId, definition_revision: bigint, timer: TimerId, generation: bigint, status: TimerJobStatus, 
/**
 ...
 */
remaining_ms: number, persistence: TimerPersistence, };
