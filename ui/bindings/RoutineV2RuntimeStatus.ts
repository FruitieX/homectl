 ...
 */
export type RoutineV2RuntimeStatus = { definition_revision: bigint, fingerprint: string, 
/**
 ...
 */
matched_trigger_ids: Array<NodeId>, triggers: Array<TriggerRuntimeStatus>, condition: ConditionEvaluation, 
/**
